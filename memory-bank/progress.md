...
| 任务 18 全局快捷键 | ✅ 自实现 Carbon `RegisterEventHotKey`，零三方依赖 |
| 任务 19 搜索和过滤 | ✅ |
| 任务 20 配置导入导出 | ⏳ 未开始 |
| 任务 21 通知中心集成 | ⏳ 未开始 |
...
| 2026-06-08 | `HostWriteCoordinator` 移除 `rolledBackConfig` 返回值 | 与 2026-05-27 设计调整对齐，清理 API artifact |
...
| 2026-06-16 | DMG 拖拽安装体验与 Finder 布局定制 | 提升独立分发 DMG 包的首次安装用户体验 |
| 2026-06-18 | 自实现 Carbon 全局快捷键，移除 KeyboardShortcuts 三方依赖 | 维持「零三方依赖」承诺；Carbon `RegisterEventHotKey` 是官方稳定 API，无需输入监控授权，KeyboardShortcuts 内部也是这么包的 |
